...
abstract class TicketRepository {
  ...
  Future<Either<Failure, void>> assignTicket(String ticketId, String helpdeskId, String helpdeskName);
  Future<Either<Failure, void>> acceptTicket(String ticketId);
  Future<Either<Failure, void>> resolveTicket(String ticketId);
  Future<Either<Failure, void>> cancelTicket(String ticketId);
